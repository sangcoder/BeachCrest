...
(87, 2, '2019-06-23 12:36:12', 'Võ Văn Sang', 2, '2019-06-23 05:36:12', '2019-06-23 05:38:03', 55, 46, NULL);
...
(178, 'Nguyễn Văn Toàn', NULL, 0, 'NhaTrang', 0, 87, '2019-06-23 05:36:12', '2019-06-23 05:36:12', 1, 'sang.vv.57cntt@ntu.edu.vn', '0979340304'),
(179, 'Võ Văn Sang', '2004-06-07', 1, 'NhaTrang', 1, 87, '2019-06-23 05:36:13', '2019-06-23 05:36:13', 0, NULL, NULL),
(180, 'Võ Thị Hường', '2007-06-07', 1, 'NhaTrang', 0, 87, '2019-06-23 05:36:13', '2019-06-23 05:36:13', 0, NULL, NULL);
...
(146, '2019_06_23_112614_update_table_tour_null_note', 25);
...
(28, 5348900, 87, '2019-06-23 05:36:18', '2019-06-23 05:38:03', '2019-06-23 12:36:18', 2, 'PAYID-LUHRAKA1W256715TR8668306');
...
--
-- Truncate table before insert `promotion_tour`
--

TRUNCATE TABLE `promotion_tour`;
--
...
--
-- Truncate table before insert `scenic__culture_tour`
--

TRUNCATE TABLE `scenic__culture_tour`;
--
...
--
-- Truncate table before insert `scenic__cultures`
--

TRUNCATE TABLE `scenic__cultures`;
--
...
--
-- Truncate table before insert `schedule_tour_guider`
--

TRUNCATE TABLE `schedule_tour_guider`;
--
...
--
-- Truncate table before insert `social_networks`
--
...
--
-- Truncate table before insert `tour_guiders`
--

TRUNCATE TABLE `tour_guiders`;
--
...
(46, 'Nguyễn Văn Toàn', 'sang.vv.57cntt@ntu.edu.vn', '$2y$10$fOEu.uURdPjIFU1CZfI4OugOQuUzFcpP5QIDN77J2C3GshwiBSXNC', 1, 'profile.png', NULL, '', '2019-06-03 09:08:14', NULL, '2019-06-03 09:07:31', '2019-06-23 08:57:33', NULL);
...
--
ALTER TABLE `bookings`
  MODIFY `BookingID` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=88;
--
-- AUTO_INCREMENT for table `customers`
--
ALTER TABLE `customers`
  MODIFY `CustomerID` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=181;
--
